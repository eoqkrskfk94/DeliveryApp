package com.mj.deliveryapp.screen.review
...
import com.mj.deliveryapp.databinding.ActivityAddRestaurantReviewBinding
import com.mj.deliveryapp.screen.review.camera.CameraActivity
import com.mj.deliveryapp.screen.review.gallery.GalleryActivity
import com.mj.deliveryapp.widget.adapter.PhotoListAdapter
...
class AddRestaurantReviewActivity : AppCompatActivity() {
    ...
    private fun uploadArticle(userId: String, title: String, content: String, rating: Float, imageUrlList: List<String>) {
        ...
        hideProgress()
        Toast.makeText(this, "review uploaded successfully", Toast.LENGTH_SHORT).show()
        finish()
    }
